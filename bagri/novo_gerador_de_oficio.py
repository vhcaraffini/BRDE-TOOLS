...
from funcoes import data_manuscrita, transforma_ponto_em_virgula, configura_paragrafo, cabecalho_e_rodape
...
# Abrindo Excel e planilhas
workbook = openpyxl.load_workbook(F'{PATH}/OFICIO.xlsx')
